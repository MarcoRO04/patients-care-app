...
export default {
  ...
  methods: {
    ...
    calculateFuturePrescriptionDate() {
      ...
      const dates_difference = Date.parse(this.recipe.future_prescription_date)
      ...
      this.recipe.distance_between_prescriptions = dates_difference / day
      console.log(this.recipe.distance_between_prescriptions)
    },
  },
}
</script>
