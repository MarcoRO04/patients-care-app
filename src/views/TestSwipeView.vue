  ...
  <div>
    <div>
      <div class="biggest_box">
        <ul>
          <!-- data-type=0 hides the delete button,
          data-type=1 shows the delete button -->
          <li class="li_vessel" v-for="(item, index) in lists" data-type="0" :key="index">
            ...
            <div @touchstart.capture="touchStart" @touchend.capture="touchEnd" @click="oneself">
              <div class="contant">
                ...
                <div class="rightBox" style="color: black">
                  <div>{{ item.title }}</div>
            ...
            <div class="removeBtn" @click="remove" :data-index="index">remove</div>
          </li>
        </ul>
      </div>
    </div>
...
.li_vessel[data-type='1'] {
  /* The larger the -64px setting,
  the further you can slide left. It
  is best to set the same value as the width
  and positioning distance of the delete button below*/
